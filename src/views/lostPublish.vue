            ...
            <template v-for="(item, index) of dataList" :key="index">
                <li class="scrollbar-demo-item">
                    ...
                    <div class="lostInfo">
                        ...
                        <el-button @click="handleDelete(item.lostImageUrl, index)" type="danger" circle>
                            <el-icon>
                                <Delete />
                            </el-icon>
                        </el-button>
        ...
        <el-dialog v-model="centerDialogVisible" title="编辑失物信息" width="30%" align-center center>
            ...
            <el-form ref="ruleFormRef" label-position="right" label-width="100px" style="max-width: 460px">
                ...
                <el-form-item label="失物描述:">
                    <el-input v-model="publishInfo.lostDescribe" />
                </el-form-item>
...
export default {
    ...
    methods: {
        handleDelete(url, index) {// 删除发布信息
            ...
            axios.post('http://localhost:3000/userDeletePublishLostInfo', imgUrl).then(res => {
