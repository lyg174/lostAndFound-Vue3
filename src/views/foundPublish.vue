    ...
    <div class="found">
        ...
        <el-card class="box-card01">
            ...
            <el-table :data="dataList" style="width: 100%" table-layout="fixed" max-height="550">
                <el-table-column prop="lostImageUrl" label="招领物图片" align="center">
                ...
                <el-table-column prop="status" label="是否寻回" align="center">
...
export default {
    ...
    methods: {
        ...
        handleChange(status, id) {
            ...
            axios.post('http://localhost:3000/userPublishFoundChangeStatus', { status, id }).then(res => {
